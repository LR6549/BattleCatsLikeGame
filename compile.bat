...
set linkingFlags=-lSDL3 -lSDL3_image -lSDL3_mixer -lSDL3_net -lSDL3_rtf -lSDL3_ttf -luser32 -lgdi32 -lole32 -luuid -loleaut32 -limm32 -ldinput8 -lwinmm -lshell32 -lsetupapi -lversion -lwininet -lws2_32
